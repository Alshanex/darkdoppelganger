...
public class DarkDoppelgangerRenderer_old extends LivingEntityRenderer<DarkDoppelgangerEntity, PlayerModel<DarkDoppelgangerEntity>> {
    ...
    public DarkDoppelgangerRenderer_old(EntityRendererProvider.Context context) {
